...
import tools.nprl_image_load as nda
import matplotlib.image  as mpimg
import model as model
import argument_nlpr3 as argument
import os
args = argument.args  
...
def save_bad_result(output,rgb,depth,gt,dir_path,name,loss):
      ...
      gt_dir = dir_path + '/gt/' + name  + '.jpg'
      depth_dir = dir_path + '/depth/' + name  + '.jpg'
      output_dir = dir_path + '/output/' + name  + '_'+ str(loss) + '.jpg'
...
def ansys(p,rd, r, d,name,dir_path):
      ...
      p_path = dir_path + '/p/' + name  + '.jpg'
      rd_path = dir_path + '/rd/' + name  + '.jpg'
      r_path = dir_path + '/r/' + name  + '.jpg'
      d_path = dir_path + '/d/' + name  + '.jpg'
...
#            print(name[0], ' done, cross loss: ', loss.item(), '  l1 loss:', mse.item())
            ...
            save_d( output  , result_dir + '/' + name[0] + '.jpg')
